 ...
 */
public class part2 {
    enum CommandoType {turnOn, turnOff, toggle};
    ...
    public void start() {
        ...
        for (int i=0; i < input.length; i++) {
            ...
            str = str.substring( str.indexOf(' ') + (" through ".length()), str.length());

            Vector2D end = new Vector2D(
                    Integer.parseInt( str.substring(0, str.indexOf(',')) ),
                    Integer.parseInt( str.substring(str.indexOf(',') + 1, str.length()) )   );

            runCommand(commandoType, start, end);
        }

        logOutput();
    }

    private void runCommand(CommandoType type, Vector2D start, Vector2D end) {
...
//        public Vector2D( String coordinateString ) {  // Constructor  takes Coordinate like this "123,092"
//            this.x = Integer.parseInt(coordinateString.substring(0, coordinateString.indexOf(',')));
//            this.y = Integer.parseInt(coordinateString.substring(coordinateString.indexOf(',') + 1, coordinateString.length()));;
//        }
     }
}
